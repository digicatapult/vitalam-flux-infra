...
- **Perform a [cursory search](https://github.com/search?q=+is%3Aissue+user%3Adscp-flux-infra)** to see if the problem has already been reported. If it has **and the issue is still open**, add a comment to the existing issue instead of opening a new one.

#### How Do I Submit A (Good) Bug Report?

Bugs are tracked as [GitHub issues](https://guides.github.com/features/issues/). Create an issue on that repository and provide the following information by filling in [the template](https://github.com/digicatapult/dscp-flux-infra/.github/blob/main/.github/ISSUE_TEMPLATE/bug_report.md).
...
- **Perform a [cursory search](https://github.com/search?q=+is%3Aissue+user%3Adscp-flux-infra)** to see if the enhancement has already been suggested. If it has, add a comment to the existing issue instead of opening a new one.
